...
class MyPageViewModelFactory(
    ...
    override fun <T : ViewModel?> create(modelClass: Class<T>): T =
        modelClass.getConstructor(GetUserUseCase::class.java, GetUserDetailUseCase::class.java, UserService::class.java, UserRepository::class.java, CompositeDisposable::class.java)
            .newInstance(getUserUseCase, getUserDetailUseCase, userService, userRepository,  compositeDisposable)
}